...
This directory contains Apache Airflow configuration and DAGs for the AI-Powered Research Assistant project.
...
- **Credentials**: set via `.env` (see `AIRFLOW_ADMIN_*` variables)
